...
static const struct cmd_whitelist_entry cmd_whitelist[] = {
	...
	{ { "bootflow", "scan", ALL }, { CMD_CAT_BOOTFLOW_CONTROL, CMD_CAT_EXEC, CMD_CAT_NEEDED } },
#ifdef CONFIG_CMD_BOOTFLOW_FULL
	{ { "bootflow", "list", ALL }, { CMD_CAT_BOOTFLOW_DIAG } },
	{ { "bootflow", "select", ALL }, { CMD_CAT_BOOTFLOW_CONTROL } },
	{ { "bootflow", "info", ALL }, { CMD_CAT_BOOTFLOW_DIAG } },
	{ { "bootflow", "read", ALL }, { CMD_CAT_BOOTFLOW_CONTROL } },
	{ { "bootflow", "boot", ALL }, { CMD_CAT_BOOTFLOW_CONTROL, CMD_CAT_EXEC } },
	// { { "bootflow", "menu", ALL }, { CMD_CAT_BOOTFLOW__TBD } },
	// { { "bootflow", "cmdline", ALL }, { CMD_CAT_BOOTFLOW__TBD } },
#endif
#endif
	...
	{ { "nvme", "scan", ALL }, { CMD_CAT_NVME_CONTROL } },
	{ { "nvme", "detail", ALL }, { CMD_CAT_NVME_DIAG } },
	{ { "nvme", "info", ALL }, { CMD_CAT_NVME_DIAG } },
	{ { "nvme", "dev", ALL }, { CMD_CAT_NVME_CONTROL } }, /* alias to "device" */
	{ { "nvme", "device", ALL }, { CMD_CAT_NVME_CONTROL } },
	{ { "nvme", "part", ALL }, { CMD_CAT_NVME_DIAG } },
	{ { "nvme", "read", ALL }, { CMD_CAT_NVME_READ } },
	{ { "nvme", "write", ALL }, { CMD_CAT_NVME_WRITE } },
#endif /* CONFIG_CMD_NVME */
	...
	{ { "pci", "enum", ALL }, { CMD_CAT_PCI_CONTROL } },
	{ { "pci", "header", ALL }, { CMD_CAT_PCI_DIAG } },
	{ { "pci", "bar", ALL }, { CMD_CAT_PCI_DIAG } },
	{ { "pci", "regions", ALL }, { CMD_CAT_PCI_DIAG } },
	{ { "pci", "display", ALL }, { CMD_CAT_PCI_READ } },
	{ { "pci", "display.b", ALL }, { CMD_CAT_PCI_READ } },
	{ { "pci", "display.w", ALL }, { CMD_CAT_PCI_READ } },
	{ { "pci", "display.l", ALL }, { CMD_CAT_PCI_READ } },
	{ { "pci", "next", ALL }, { CMD_CAT_PCI_WRITE } },
	{ { "pci", "next.b", ALL }, { CMD_CAT_PCI_WRITE } },
	{ { "pci", "next.w", ALL }, { CMD_CAT_PCI_WRITE } },
	{ { "pci", "next.l", ALL }, { CMD_CAT_PCI_WRITE } },
	{ { "pci", "modify", ALL }, { CMD_CAT_PCI_WRITE } },
	{ { "pci", "modify.b", ALL }, { CMD_CAT_PCI_WRITE } },
	{ { "pci", "modify.w", ALL }, { CMD_CAT_PCI_WRITE } },
	{ { "pci", "modify.l", ALL }, { CMD_CAT_PCI_WRITE } },
	{ { "pci", "write", ALL }, { CMD_CAT_PCI_WRITE } },
	{ { "pci", "write.b", ALL }, { CMD_CAT_PCI_WRITE } },
	{ { "pci", "write.w", ALL }, { CMD_CAT_PCI_WRITE } },
	{ { "pci", "write.l", ALL }, { CMD_CAT_PCI_WRITE } },
	{ { "pci", "*" }, { CMD_CAT_PCI_DIAG } },
	{ { "pci", "*", "long" }, { CMD_CAT_PCI_DIAG } },
	{ { "pci", ALL }, { CMD_CAT_PCI_OTHER } },
