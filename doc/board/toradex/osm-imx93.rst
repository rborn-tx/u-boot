...
- SoM: https://www.toradex.com/computer-on-modules/osm-arm-family/nxp-imx93
- Carrier board: https://www.toradex.com/products/carrier-board/osm-development-board-kit
...
.. code-block:: bash
   ...
   $ export CROSS_COMPILE="aarch64-linux-gnu-"
   $ make toradex-osm-imx93_defconfig
   $ make
